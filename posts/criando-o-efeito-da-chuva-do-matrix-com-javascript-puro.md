...
Nesse post eu serei bem detalhista e farei bem passo-a-passo, já que muita gente pode não estar ambientada com o conceito de Canvas e quero também fazer algo onde qualquer iniciante consiga acompanhar.
...
Repare que eu fiz um loop iniciando com `i=0`, isso significa que nossa primeira letra será impressa na posição `(0, 18)`, afinal de contas `0 * 18 === 0` e como todos os items dentro de `drops` tem o valor iniciado como `1`, `drops[0] = 1 * 18 === 18`.
...
E pronto! Sua chuva da Matrix está feitinha! O [código completo está bem aqui](https://github.com/willianjusten/labs/blob/main/matrix-rain/index.html).
